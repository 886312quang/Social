...
const FriendProfile = () => {
  ...
  // user
  const friendProfile = useSelector(userSelectors.selectFriendProfile);

  useEffect(() => {
    dispatch(userActions.getFriendProfile(userId));
  }, [userId]);
              ...
              <Card.Body className=" profile-page p-0">
                <div className="profile-header profile-info">
                  ...
                  <div className="user-detail text-center mb-3">
                    ...
                    <div className="profile-detail img-fluid">
                      {friendProfile ? (
              ...
              <Card>
                ...
                <Card.Body>
                  <ul className="list-inline p-0 m-0">
                    {friendProfile && friendProfile.about.job ? (
                      <li className="mb-2 d-flex align-items-center">
                        <i className="ri-user-line pe-3 font-size-20"></i>
                        <p className="mb-0">{friendProfile.about.job}</p>
                      </li>
                    ) : null}
                    {friendProfile && friendProfile.about.education ? (
                      <li className="mb-2 d-flex align-items-center">
                        <i className="ri-git-repository-line pe-3 font-size-20"></i>
                        <p className="mb-0">{friendProfile.about.education}</p>
                      </li>
                    ) : null}
                    {friendProfile && friendProfile.about.address ? (
                      <li className="mb-2 d-flex align-items-center">
                        <i className="ri-map-pin-line pe-3 font-size-20"></i>
                        <p className="mb-0">{friendProfile.about.address}</p>
                      </li>
                    ) : null}
                    {friendProfile && friendProfile.about.marriage ? (
                      <li className="d-flex align-items-center">
                        <i className="ri-heart-line pe-3 font-size-20"></i>
                        <p className="mb-0">{friendProfile.about.marriage}</p>
                      </li>
                    ) : null}
                  </ul>
                </Card.Body>
