                ...
                <div className="profile-header">
                  ...
                  <div className="user-detail text-center mb-3">
                    ...
                    <div className="profile-detail">
                      {friendProfile ? <h3>{friendProfile.userName}</h3> : null}
                    </div>
                  </div>
                            ...
                            <Tab.Content>
                              <Tab.Pane eventKey="about1">
                                ...
                                <Row>
                                  ...
                                  <div className="col-9">
                                    <p className="mb-0">
                                      {friendProfile && friendProfile.phone
                                        ? friendProfile.phone
                                        : null}
                                    </p>
                                  </div>
                                  ...
                                  <div className="col-9">
                                    <p className="mb-0">
                                      {friendProfile && friendProfile.address
                                        ? friendProfile.address
                                        : null}
                                    </p>
                                  </div>
                                </Row>
